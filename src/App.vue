...
nav {
  ...
  section {
    ...
    &.homepage { display: flex; flex-flow: column;  min-height: 38vh; padding: 30px 1em 56px 1em; }
...
main.words {
  ...
  .word {
    ...
    .main-word {
      // avoid anoing selection on mobile device
